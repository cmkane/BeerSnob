...
def connect_type(word_list):
    """ This function takes a list of words, then, depeding which key word, returns thecorresponding
...
# Account Information
to = 'beersnobmail@gmail.com' # Email to send to. (CAN BE ANYTHING)
gmail_user = 'beersnobmail@gmail.com' # Email to send from. (MUST BE GMAIL)
gmail_password = 'raspberryisafruit' # Gmail password.
tries = 0
while True:
     if (tries > 60):
         exit()
